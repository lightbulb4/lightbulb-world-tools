...
- Results are sorted largest first by imported longest-side resolution. **4096**, **2048**, **1024**, and **512** selection buttons select only removable textures of that exact size and clear other selections, including filtered-out rows. Smaller textures remain available for individual selection; there are no presets below 512.
